...
function Keypad() {
  ...
  return (
    <>
      <StatusBar />
      <div className="grid grid-rows-[auto_1fr_auto] h-[670px] place-items-center xsm:min-h-[calc(100vh-140px)]">
        {/* Display */}
        <div className="flex flex-col items-center justify-end mt-[2rem] h-24">
