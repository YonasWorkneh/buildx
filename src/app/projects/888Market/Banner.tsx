    ...
    <div className="h-full w-full flex items-center justify-center py-2 sm:py-4 px-2 sm:px-4">
      <div className="relative w-full max-w-[800px]">
        ...
        <motion.div
          ...
          className="absolute top-[65%] left-[-130px] sm:top-[30%] md:top-[150px] sm:right-0 md:right-[-100px] w-[180px] sm:w-[220px] md:w-[280px] lg:w-[280px] h-[400px]  p-2 sm:p-6 md:p-6  "
        >
          <Image
            src={"/img/eth-mob.png"}
            alt="eth-mobile ui"
        ...
        >
          ...
          <p className="text-white/40 text-[10px] sm:text-xs md:text-sm mt-1 sm:mt-2">
            Full-stack ecommerce platform that resembles dubizzle.
          </p>
